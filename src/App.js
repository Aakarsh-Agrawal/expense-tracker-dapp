...
function App() {
  ...
  const contractAddress = "0xD7d6ca97bd13EB3984E62b4356d5c4Bb8B0d8375"; // Paste the address recieved from Remix IDE here
                        ...
                        {expense.participants.map((p, idx) => (
                          <tr key={idx}>
                            <td style={{ padding: "5px", border: "1px solid #ddd" }}>
                              ...
                              {people.find((person) => person.address === p.address)?.name ||
                                p.address.substring(0, 8)}
                            </td>
                            <td style={{ padding: "5px", border: "1px solid #ddd" }}>
                              {showInINR
                                ? `₹${(
