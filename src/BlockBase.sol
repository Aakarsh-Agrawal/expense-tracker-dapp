...
contract ExpenseTracker {
    ...
    * @return The total count of registered people
    */
        /**
     * @dev Update the name of the registered user
     * @param _newName The new name to be updated
     */
    function updateName(string memory _newName) public {
        // Ensure the user is registered
        require(people[msg.sender].walletAddress != address(0), "User not registered");
        ...
        // Optional: Emit an event for the frontend
        emit PersonRegistered(msg.sender, _newName);
    }
}
